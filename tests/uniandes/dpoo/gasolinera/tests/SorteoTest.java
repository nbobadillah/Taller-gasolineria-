...
class SorteoTest {
	...
	public void testDosOpciones() {
		...
		for (int i = 0; i < 1000; i++) {
			seleccionada = Sorteo.seleccionarAlAzar(opciones);
			assertTrue(A.equals(seleccionada) || B.equals(seleccionada),
					"Siempre debería queda seleccionada una de las dos opciones");
		}
	}
	...
	public void testBalanceado() {
		...
		assertEquals(promedioEsperado, promedio, promedioEsperado * 0.15,
				"No debería haber más de un 15% de diferencia en la cantidad de veces que apareció cada valor");
	}
}
