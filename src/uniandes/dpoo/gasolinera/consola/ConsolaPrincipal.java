...
public class ConsolaPrincipal extends ConsolaBasica {
	 ...
	 */
	private final String[] opcionesMenuPrincipal = new String[] { "Usar gasolinera actual", "Crear nueva gasolinera",
			"Cargar gasolinera de un archivo", "Guardar gasolinera a un archivo", "Salir" };
	...
	/**
	 * Muestra el menú principal de la aplicación y ejecuta la opción que seleccione
	 * el usuario.
	 * 
	 * El menú vuelve a mostrarse hasta que el usuario seleccione la opción para
	...
	/**
	 * Muestra las opciones para interactuar con una gasolinera, utilizando una
	 * instancia de la clase ConsolaUsarGasolinera
	 */
	...
	/**
	 * Le pide al usuario el nombre de un archivo y luego crea una nueva Gasolinera
	 * utilizando la información contenida en el archivo.
	 */
	private void cargarGasolinera() {
		String nombreArchivo = pedirCadenaAlUsuario(
				"Indique el archivo con la información de la gasolinera. El archivo debe estar dentro de la carpeta 'datos'");
	...
	/**
	 * Le pide al usuario el nombre de un archivo y luego guarda en el archivo el
	 * estado de la gasolinera sobre la que se está trabajando.
	 */
	private void guardarGasolinera() {
		if (laGasolinera == null) {
			...
			String nombreArchivo = pedirCadenaAlUsuario(
					"Indique el nombre del archivo donde guardará la gasolinera en su estado actual. El archivo se guardará dentro de la carpeta 'datos'");
			if (!nombreArchivo.trim().equals("")) {
				File archivo = new File("./datos/" + nombreArchivo);

				boolean confirmar = true;
				if (archivo.exists()) {
					confirmar = pedirConfirmacionAlUsuario(
							"El archivo " + nombreArchivo + " ya existe. ¿Está seguro de que quiere reemplazarlo?");
				}
				if (confirmar) {
					try {
						laGasolinera.guardarEstado(archivo);
						System.out.println("El estado actual de la gasolinera fue salvado en el archivo "
