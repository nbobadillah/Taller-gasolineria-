...
public abstract class ConsolaBasica {
	...
	/**
	 * Muestra la información actual de una gasolinera, pero sólo muestra los
	 ...
	 */
	protected void mostrarEstadoActual(int cantidadSurtidores, Collection<TipoGasolina> tiposGasolina,
	...
	/**
	 * Muestra la información actual de una gasolinera, incluyendo los nombres de
	 * los empleados y la cantidad de dinero que han recibido
	 * 
	 * @param cantidadSurtidores
	 * @param tiposGasolina
	 * @param empleados
	...
	private void mostrarInformacionBasica(int cantidadSurtidores, Collection<TipoGasolina> tiposGasolina) {
		...
		System.out.println("La gasolinera tiene actualmente " + cantidadSurtidores
				+ (cantidadSurtidores > 1 ? " surtidores" : " surtidor"));
		...
		for (TipoGasolina tipo : tiposGasolina) {
			...
			System.out.println("   - " + tipo.getNombre() + ": " + tipo.getPrecioPorGalon() + " por galón, "
					+ galonesDisponibles + " galones disponibles");
		}
	}
