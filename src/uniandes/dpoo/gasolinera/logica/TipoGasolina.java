...
/**
 * Encapsula la información sobre un tipo de gasolina disponible en la
 * gasolinera.
 * 
 * Esta clase será la encargada de saber cuánta gasolina de un determinado tipo
 * hay aún disponible en la gasolinera
 */
public class TipoGasolina {
	...
	public void despacharGasolina(double cantidadSolicitada) throws GasolinaInsuficienteException {
		...
		if (cantidadSolicitada > cantidadDisponible) {
			GasolinaInsuficienteException ex = new GasolinaInsuficienteException(nombre, cantidadDisponible,
					cantidadSolicitada);
			throw ex;
		}
