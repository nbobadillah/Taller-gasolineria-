...
/**
 * Esta clase tiene la información de una Gasolinera incluyendo los tipos de
 * gasolina, los empleados y los surtidores
 */
public class Gasolinera {
	...
	/**
	 * Un mapa de los tipos de gasolina en venta: las llaves son el nombre del tipo
	 * de gasolina
	 */
	private Map<String, TipoGasolina> tiposGasolina;

	/**
	 * Un mapa con los empleados de la gasolinea: las llaves son el nombre del
	 * empleado
	 */
	 ...
	 * 
	 * Inicialmente no se va a haber vendido ningún galón de ningún tipo de gasolina
	 * y los empleados no habrán recaudado dinero.
	 * 
	 * @param cantidadSurtidores La cantidad de surtidores en la gasolinera
	 * @param listaTiposGasolina Una lista de TipoGasolina con la información de
	 *                           cada tipo en venta en la gasolinería
	 * @param nombresEmpleados   Un arreglo con los nombres de los empleados que
	 *                           trabajan en la gasolinera
	 */
	public Gasolinera(int cantidadSurtidores, List<TipoGasolina> listaTiposGasolina, String[] nombresEmpleados) {
		...
		// Construir los surtidores de la gasolinera usando los tipos de gasolina y
		// asignarle empleados aleatoriamente
		this.surtidores = new Surtidor[cantidadSurtidores];
		for (int i = 0; i < cantidadSurtidores; i++) {
			Empleado[] dummy = new Empleado[] {}; // Este arreglo se usa únicamente para indicarle el tipo genérico al
													// método toArray de Collection
	 ...
	 * Construye una nueva gasolinera con la información entregada.
	 * 
	 * Este constructor asume que los objetos están correctamente enlazados: los
	 * tipos de gasolina en los surtidores son los mismos que estarán en la
	 * gasolinera, y los empleados asignados a los surtidores son los mismos que
	 * estarán en la gasolinera.
	 * 
	 * @param surtidores    Los surtidores de la gasolinera
	 * @param tiposGasolina Una coleción de TipoGasolina con la información de cada
	 *                      tipo en venta en la gasolinería
	 * @param empleados     Una colección con los empleados que trabajan en la
	 *                      gasolinera
	 */
	private Gasolinera(List<Surtidor> surtidores, Collection<TipoGasolina> tiposGasolina,
	...
	/**
	 * Le vende a un cliente una cierta cantidad de gasolina, dada la cantidad de
	 * gasolina que quiere el cliente.
	 * 
	 * Si en la gasolinera no hay la cantidad suficiente del tipo de gasolina, le
	 * vende todo lo que haya de esa gasolina.
	 * 
	 * Después de realizada la transacción, debe haber quedado actualizado el
	 * inventario de gasolina (en el TipoGasolina), la cantidad entregada en el
	 * surtidor y la cantidad de dinero que tiene el empleado que atiende en el
	 * surtidor.
	 * 
	 ...
	 * @param numeroSurtidor     El número del surtidor donde están atendiendo al
	 *                           cliente. Los surtidores están numerados desde 0.
	 * @return El precio de la gasolina que se le vendió al cliente (no
	 *         necesariamente es la cantidad solicitada)
	 */
	...
	/**
	 * Le vende a un cliente una cierta cantidad de gasolina, dado el precio que
	 ...
	 * 
	 * @param nombreTipoGasolina El tipo de gasolina que quiere el cliente
	 * @param valorSolicitado    El precio que quiere pagar el cliente por la
	 *                           gasolina que se le entregue
	 * @param numeroSurtidor     El número del surtidor donde están atendiendo al
	 *                           cliente. Los surtidores están numerados desde 0.
	 * @return El precio de la gasolina que se le vendió al cliente (no
	 *         necesariamente es el valor solicitado)
	 */
	 ...
	 * @throws IOException Se lanza esta excepción si hay problemas escribiendo en
	 *                     el archivo
	 */
	public void guardarEstado(File archivo) throws IOException {
		...
		for (TipoGasolina tipo : tiposGasolina.values()) {
			writer.println(
					"tipo:" + tipo.getNombre() + ":" + tipo.getPrecioPorGalon() + ":" + tipo.getCantidadDisponible());
		}
	...
	/**
	 * Carga toda la información de una gasolinera a partir de un archivo y retorna
	 * una nueva Gasolinera inicializada con esa información
	 * 
	 * @param archivo El archivo que contiene la información que se va a cargar
	 * @return Una nueva gasolinera con su estado inicializado con la información
	 *         del archivo
	 * @throws FileNotFoundException Se lanza esta excepción si el archivo no se
	 *                               encuentra
	 * @throws IOException           Se lanza esta excepción si el archivo no se
	 *                               puede leer
	 * @throws NumberFormatException Se lanza esta excepción si alguno de los
	 *                               números dentro del archivo tiene el formato
	 *                               equivocado
	 */
	public static Gasolinera cargarEstado(File archivo)
