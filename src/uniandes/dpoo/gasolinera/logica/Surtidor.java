 ...
 * 
 * Todos los surtidores entregan gasolina de los mismos tanques, pero cada
 * surtidor lleva la cuenta de cuánto ha entregado, de cada tipo de gasolina.
 *
 */
public class Surtidor {

	/**
	 * Un mapa donde se lleva la cuenta de los galones de gasolina entregados por
	 * tipo de gasolina.
	 * 
	 * La llave del mapa es el nombre del tipo de gasolina, y el valor es la
	 * cantidad de galones.
	 */
	...
	/**
	 * Retorna la cantidad de galones de gasolina vendidos en el surtidor según el
	 * tipo de gasolina.
	 * 
	 * @param nombreTipoGasolina El nombre del tipo de gasolina
	 * @return La cantidad de galones, o null si el tipo de gasolina no se ofrece en
	 *         el surtidor
	 */
	 ...
	 * 
	 * @param nombreTipoGasolina El nombre del tipo de gasolina
	 * @param cantidad           La nueva cantidad que estará registrada en el
	 *                           surtidor
	 */
	...
	/**
	 * Retorna un arreglo con los nombres de los tipos de gasolina disponibles en el
	 * surtidor
	 * 
	...
	public String[] getTiposGasolina() {
		...
		String[] dummy = new String[] {}; // Este arreglo vacío sirve solo para indicarle el tipo al método toArray de
											// Collection
		return conjuntoLlaves.toArray(dummy);
	}

	/**
	 * Retorna el objeto con la descripción completa del tipo de gasolina
	 * seleccionado
	 * 
	 * @param nombreTipoGasolina El nombre del tipo de gasolina
	...
	/**
	 * Este método registra una venta de gasolina en el surtidor. El método debe
	 * hacer dos acciones:
	 * 
	 * 1. Calcular el precio de la gasolina vendida y registrar que el empleado
	 ...
	 * @param cantidadEntregada  La cantidad de galones de gasolina que se le
	...
	public int venderGasolina(String nombreTipoGasolina, double cantidadEntregada) {
		// Calcular el precio de la gasolina vendida y registrar que el empleado tiene
